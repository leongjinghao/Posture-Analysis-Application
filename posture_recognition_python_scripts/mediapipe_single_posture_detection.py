...
cap = cv2.VideoCapture('posture_recognition_python_scripts/video_sample/dancing3.mp4')
pTime = 0
writeLM = False
...
if writeLM:
    ...
    open('posture_recognition_python_scripts/model_training/posture_log_file/landmark_data_normalzone.txt', 'w')
        ...
        for id, lm in enumerate(results.pose_landmarks.landmark):
            ...
            if writeLM:
                if id < 32:
                    ...
                    delimiter = ', {0}\n'.format(posClass)
                with open('posture_recognition_python_scripts/model_training/posture_log_file/landmark_data_normalzone.txt', 'a') as f:
